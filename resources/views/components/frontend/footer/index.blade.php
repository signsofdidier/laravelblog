<footer class="footer-area bg-img background-overlay" style="background-image: url({{ asset('assets/frontend/img/bg-img/4.jpg') }});">
    <!-- Top Footer Area -->
...
<!-- Voeg dit toe aan je hoofd-layout of specifieke view -->
