<section class="single-post-area">
    <!-- Single Post Title -->
    <div class="single-post-title bg-img background-overlay" style="background-image: url({{ asset('assets/frontend/img/bg-img/1.jpg') }});">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    <div class="single-post-thumb">
                        <img src="{{ asset('assets/frontend/img/blog-img/24.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-8">
                    <div class="single-post-text">
