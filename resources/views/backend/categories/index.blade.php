...
@section('content')
    <div class="">
        @include('layouts.partials.flash_message') {{-- vervang dit eens met componentje als oefening --}}
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    @foreach($categories as $category)
                        <tr>
                            <td>{{ $category->name }}</td>
                            <td>{{ $category->posts_count }}</td>{{--count can door de withCount in de controller--}}
                            <td>
                                @if($category->trashed())
